...
---
### *5mins*
### @TODO: save CSV file from eco data and import it with readr
...
non-proprietry formats OSS, open standard formats. Used by anyone, dont need special software to use these data files, such as .txt or .csv. .CSV is the most common format.

Benefit of text files, is that you can put them under version control.
