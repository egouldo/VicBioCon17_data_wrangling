...
*1. Skipping meatdata or comments with the `skip` argument*


*2.  *

- skipping lines, useful if you have metadata up the top
- when you don't have column names
...
- when missing values are represented by a string other than NA in your flat file.
- parsing in data - column specification
