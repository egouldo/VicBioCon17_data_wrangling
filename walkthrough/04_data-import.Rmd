...
> 1. Go to the [workshop repository data folder](https://github.com/egouldo/VicBioCon17_data_wrangling/tree/master/data) and download the csv files called `bat_dat.csv` and `iris.csv`
...
*5-minute challenge: parsing column type specification*
...
**1-minute Challenge: interactice sorting and filtering**
